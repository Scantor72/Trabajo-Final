...
var style_MapaRiesgos_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PonderadoFinal");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1.100000 && value <= 2.100000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.100000 && value <= 2.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.800000 && value <= 3.800000) {
            style = [ new ol.style.Style({
